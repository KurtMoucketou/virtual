import SectionBottomShapeEtablissementStc from "./SectionBottomShape.stc"

const SectionBottomShapeEtablissement=()=>{
    return (
        <SectionBottomShapeEtablissementStc >
            ...
            <div className="section container">
                ...
                <div className="container">
                    <div className="section-title text-center aos-init aos-animate" data-aos="fade-up">
                        <span className="sub-title">ÉTABLISSEMENTS</span>
                        <h2 className="title">La liste des écoles </h2>
                    </div>
                </div>
            </div>
            <br/><br/> <br/><br/>
...
export default SectionBottomShapeEtablissement